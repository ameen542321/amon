...
class AuthTokenController extends Controller
{
    ...
    {
        return ['app:read', 'catalog:read', 'inventory:read', 'inventory-counts:read', 'inventory-counts:write', 'people:read', 'operations:read', 'reports:read', 'governance:read', 'shifts:read', 'sales:read', 'purchase-orders:read', 'store-transfers:read', 'devices:manage', 'notifications:read', 'notifications:write', 'push:manage'];
    }
