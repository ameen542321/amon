    ...
    public function appConfig(): JsonResponse
    {
        return ApiResponse::success([
            ...
            'features' => [
                ...
                'inventory_counts_read' => true,
                'inventory_counts_draft_write' => true,
                'inventory_counts_submit' => false,
                'inventory_counts_approve' => false,
                'people_directory_read' => true,
                'people_finance_read' => false,
                'people_write' => false,
                'people_permissions_write' => false,
                'supporting_operations_read' => true,
                'supporting_operations_write' => false,
                'financial_approval_offline' => false,
                'report_catalog' => true,
                'report_monthly_summary' => true,
                'report_signed_downloads' => true,
                'report_offline_cache' => false,
                'governance_overview' => true,
                'governance_audit_read' => true,
                'subscription_write' => false,
                'account_administration_write' => false,
                'security_settings_write' => false,
                'design_system_contract' => true,
                'design_system_publish' => false,
                'design_system_rollback' => false,
                'shift_read' => true,
                'shift_gap_read' => true,
                'sales_read' => true,
                'sales_write' => false,
