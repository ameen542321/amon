    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <div class="flex items-center gap-2">
                ...
                <x-ui.help title="نطاق مراجعة الشفتات" body="تعرض الصفحة أيام الشهر الحالي المكتملة غير المغلقة، مع آخر عشرة أيام من الشهر السابق إذا بقيت غير مغلقة. لا تشمل اليوم الجاري لأنه ما زال مفتوحًا وقابلًا لتسجيل العمليات." />
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        @empty
            <div class="lg:col-span-2 rounded-3xl ui-card p-8 text-center ui-text-muted">
                لا توجد شفتات ناقصة في الشهر الحالي أو آخر عشرة أيام من الشهر السابق.
            </div>
        @endforelse
    </div>
</div>
