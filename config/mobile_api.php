...
return [
    ...
    'refresh_token_lifetime_days' => (int) env('MOBILE_API_REFRESH_TOKEN_LIFETIME_DAYS', 90),
    ...
    'report_download_ttl_minutes' => (int) env('MOBILE_API_REPORT_DOWNLOAD_TTL_MINUTES', 10),
];
